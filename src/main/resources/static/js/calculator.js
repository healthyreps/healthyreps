...
function calBodyMass() {
  ...
  } else bodyFat = 1.2 * BMI + 0.23 * age - 16.2;
  ...
  if (female) {
    BMR =
      655.1 + (4.35 / 0.453592) * weight + (4.7 / 2.54) * height - 4.7 * age;
  } else
    BMR = 66 + (6.2 / 0.453592) * weight + (12.7 / 2.54) * height - 6.76 * age;
